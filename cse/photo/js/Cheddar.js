...
Cheddar.touchHandler = function(event) {
	 ...
	 switch(event.type) {
		case "touchstart":
			Cheddar.stage.dispatchEvent("touchstart", event);
			break;
		case "touchmove":
			Cheddar.stage.dispatchEvent("touchmove", event);
			break;        
		case "touchend": 
			Cheddar.stage.dispatchEvent("touchend", event);
			break;
		default: return;
	}
...
Cheddar.onMouseMove = function (e) {
	if (e.pageX - Cheddar.canvas.offsetLeft == Cheddar.oldMouseX &&
	    e.pageY - Cheddar.canvas.offsetTop == Cheddar.oldMouseY) {
	    return;    
	}
	Cheddar.mouse.x = e.pageX - Cheddar.canvas.offsetLeft;
	Cheddar.oldMouseX = e.pageX - Cheddar.canvas.offsetLeft;
	Cheddar.mouse.y = e.pageY - Cheddar.canvas.offsetTop;
	Cheddar.oldMouseY = e.pageY - Cheddar.canvas.offsetTop;
	trace(Cheddar.oldMouseX + " " + Cheddar.oldMouseY)
