define(function(require) {
    var $ = require('jquery');
    var StaticClassToggle = require('components/StaticClassToggle');
    var Model = require('ExtendedModel');

    describe('Property Toggler', function() {
        ...
        beforeEach(function() {
            ...
            underTest = new StaticClassToggle();
            underTest.renderer = {
                $el: element
            };
        ...
        describe('starting', function() {
            ...
            it("should throw if class name isn't provided", function() {
                delete underTest.className;

                expect(function() { underTest.start(); }).to.throw("Class name must be specified.");
            });
            ...
            describe('with the matching flag set to true', function() {
                it('should make the element invisible if the property is not the propertyValue', function() {
                    ...
                    expect(underTest.renderer.$el.hasClass("selected")).to.equal(false);
                });
                ...
                it('should leave the element visible if the property is the propertyValue', function() {
                    ...
                    expect(underTest.renderer.$el.hasClass("selected")).to.equal(true);
                });
            });
